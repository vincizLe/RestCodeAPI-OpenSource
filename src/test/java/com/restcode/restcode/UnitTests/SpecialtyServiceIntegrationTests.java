...
public class SpecialtyServiceIntegrationTests {
    ...
    // last add
    @Test
    @DisplayName("When getSpecialtyById With Invalid Id Then Throws ResourceNotFoundException")
    public void WhenGetSpecialtyByIdAndConsultantIdWithInvalidIdThenThrowsResourceNotFoundException(){
        //Arrange
        ...
        specialty.setId(20L);
        specialty.setConsultant(consultant);
        Mockito.when(specialtyRepository.findByIdAndConsultantId(20L,30L)).thenReturn(Optional.empty());
        String expectedMessage = String.format( "Specialty not found with Id" + 20L +
                "and ConsultantId" + 30L);
