...
public class SaleDetailController {
    ...
    @PostMapping("/sales/{saleId}/products/{productId}/sale-details")
    public SaleDetailResource createSaleDetail(
        ...
        return convertToResource(saleDetailService.createSaleDetail(saleId,productId,convertToEntity(resource)));
    }
